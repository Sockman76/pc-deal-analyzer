# PCDeal V10.8 — Full Replacement Package
...
## V10.8 — Data Quality Upgrade

V10.8 adds a benchmark calibration layer and a secure used-market provider architecture.
...
## V10.8 — Universal shorthand aliases
...
## V10.8 — Profiled analysis redesign
...
## V10.8 account-navigation correction
...
## V10.8 — compact analyzer + benchmark-anchored FPS
...
## V10.8 — Evidence-first pricing intelligence
...
## V10.8 — Accuracy & data quality pass
...
## V10.8 — Exact product catalog foundation
...
### Important scope
No static website can truthfully contain every hardware SKU ever manufactured. V10.8 therefore uses:
...
## V10.8 — PCDeal Master Hardware Database
...
## V10.8 — Analyzer recognition correction
...
## V10.8 — Canonical recognition pipeline

V10.8 fixes the shorthand test failures discovered on the live site.
...
## V10.8 — Cooler + Case Master Database UI
...
## V10.8 — Motherboard/PSU visibility repair
...
## V10.8 — Cooler + Case custom fallback inputs
...
## V10.8
RAM type detection, CPU/GPU/Motherboard/PSU manual mirrors, canonical Visualizer state, and separate Canadian new-vs-used pricing architecture. Includes ANALYZER-TEST-V10.8.txt.
